...
using ManageEmployee2.Web.Models;

namespace ManageEmployee2.Web.Controllers
{
    public class tblEmployeesController : Controller
    {
        private ManageEmployeeDbContext db = new ManageEmployeeDbContext();
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Email,Gender,City,DepartmentId")] tblEmployee tblEmployee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Email,Gender,City,DepartmentId")] tblEmployee tblEmployee)
        {
            if (ModelState.IsValid)
            {
